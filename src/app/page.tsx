...
const perks = [
    ...
    },
    {
        ...
        Icon: CheckCircle,
        description: "Every assets on our platform is verified by our team to ensure our highest quality standards. Not Happy? We offer a a 30-day refund guarantee.",
    },
    {
        name: "For the Planet",
        Icon: LeafIcon,
        ...
        <>
            <MaxWidthWrapper>
                <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
                    ...
                    <p className="mt-6 text-lg max-w-prose text-muted-foreground">
                        Welcome to DigitalFox. Every asset on our
            ...
            <section className="border-t border-gray-200 bg-gray-50">
                <MaxWidthWrapper className="py-20">
                    <div className="grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-16 lg:grid-cols-3 lg:gap-x-8 lg:gap-y-0">
                        {perks.map((perk) => (
